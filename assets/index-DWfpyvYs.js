    ...
    function Wa(e) {
      ...
      function p(e, t, n, r) {
        ...
        if (typeof n == `object` && n) {
          ...
          if (w(n) || ce(n)) return i === null ? d(e, t, n, r, null) : null;
...
`,
  ...
  y = _.createContext && _.createContext(v),
  b = [`attr`, `size`, `title`];
function x(e, t) {
  if (e == null) return {};
  var n,
...
function ae(e) {
  return (
    e &&
    e.map((e, t) => _.createElement(e.tag, te({ key: t }, e.attr), ae(e.child)))
  );
}
function oe(e) {
  return (t) =>
    _.createElement(se, S({ attr: te({}, e.attr) }, t), ae(e.child));
}
function se(e) {
  var t = (t) => {
    ...
    return (
      ...
      _.createElement(
        ...
        S(
          ...
          {
            className: s,
            style: te(te({ color: e.color || t.color }, t.style), e.style),
            height: o,
            width: o,
  ...
  return y === void 0 ? t(v) : _.createElement(y.Consumer, null, (e) => t(e));
}
var ce = c(g(), 1);
function le(e) {
  return oe({
...
var ue = o((e) => {
  ...
  T = () =>
    (0, w.jsx)(`div`, {
      className: `flex gap-5 text-2xl text-slate-400`,
      children: (0, w.jsx)(`a`, {
        href: `https://www.linkedin.com/in/ana-vivas/`,
        target: `_blank`,
        rel: `noreferrer`,
        children: (0, w.jsx)(le, {
  ...
  E = () =>
    (0, w.jsxs)(`aside`, {
      className: `lg:sticky hidden  top-0 md:h-screen md:flex flex-col justify-between py-24 `,
      children: [
        (0, w.jsxs)(`div`, {
          children: [
            (0, w.jsx)(`p`, {
            ...
            (0, w.jsx)(`h2`, {
              className: `text-3xl text-slate-400 mt-4`,
              children: `Full Stack Developer`,
            }),
            (0, w.jsx)(`p`, {
              className: `mt-6 max-w-sm text-slate-400 leading-relaxed`,
              children: `Construyo experiencias digitales modernas, accesibles y enfocadas en rendimiento.`,
            }),
            (0, w.jsx)(`nav`, {
              className: `mt-16 hidden lg:block`,
              children: (0, w.jsxs)(`ul`, {
                className: `space-y-6 text-sm uppercase tracking-widest text-slate-500`,
                children: [
                  (0, w.jsx)(`li`, {
                    children: (0, w.jsx)(`a`, {
                      href: `#about`,
        ...
        (0, w.jsx)(`div`, { children: (0, w.jsx)(T, {}) }),
      ],
    }),
  de = ({ children: e }) =>
    (0, w.jsx)(`div`, {
      ...
      children: (0, w.jsxs)(`div`, {
        className: `lg:grid lg:grid-cols-[40%_60%] gap-10`,
        children: [
          (0, w.jsx)(E, {}),
          (0, w.jsx)(`main`, {
            className: `py-8 md:py-24 space-y-32`,
            children: e,
          }),
        ],
      }),
  ...
  fe = () => {
    ...
    return (0, w.jsxs)(`section`, {
      className: `lg:hidden pt-4 lg:pt-20 mb-4`,
      children: [
        (0, w.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, w.jsx)(`button`, {
              ...
              onClick: () => t((e) => !e),
              className: `p-2 rounded-md bg-slate-800 hover:bg-slate-700 fixed right-4 top-4 z-50`,
        ...
        e &&
          (0, w.jsxs)(`div`, {
            className: `fixed p-4 left-0 top-0 bg-slate-900/90 w-3/6 h-full`,
            children: [
              (0, w.jsx)(`nav`, {
                className: `rounded-xl`,
                children: (0, w.jsxs)(`ul`, {
                  className: `space-y-4 text-sm uppercase tracking-widest text-slate-500`,
                  children: [
                    (0, w.jsx)(`li`, {
                      children: (0, w.jsx)(`a`, {
                        href: `#about`,
  ...
  me = ({ title: e }) =>
    (0, w.jsx)(`h2`, {
      className: `text-sm uppercase tracking-[0.2em] text-primary mb-10 font-display`,
      children: e,
    }),
  D = () =>
    (0, w.jsxs)(pe, {
      id: `about`,
      children: [
        (0, w.jsx)(me, { title: `Sobre mí` }),
        (0, w.jsxs)(`div`, {
          className: `space-y-6 text-slate-400 leading-relaxed`,
          children: [
            (0, w.jsx)(`p`, {
              children: `Desarrolladora de software con 8 años de experiencia en desarrollo web, especializada durante los últimos 4 años en React, Next.js, desarrollo backend con Java y Spring, incluyendo la construcción e integración de APIs REST.`,
            }),
            (0, w.jsx)(`p`, {
              children: `Cuento con experiencia en el desarrollo de aplicaciones web y soluciones empresariales, modernización de sistemas, integración de servicios, gestión de usuarios y permisos, automatización de procesos, generación de reportes, procesos ETL y manejo de bases de datos relacionales.`,
            }),
            (0, w.jsx)(`p`, {
              children: `Utilizo herramientas de Inteligencia Artificial como apoyo al desarrollo de software, optimización y análisis de código, documentación, investigación técnica y resolución de problemas.`,
            }),
            (0, w.jsx)(`p`, {
              children: `Busco continuar creciendo como desarrolladora Full Stack, fortaleciendo mi experiencia en Java, Spring y arquitectura de aplicaciones, y aportando mis conocimientos en frontend, integración de servicios y desarrollo de soluciones tecnológicas que generen valor tangible para el negocio.`,
            }),
          ],
        }),
      ],
  ...
  O = ({ text: e }) =>
    (0, w.jsx)(`span`, {
      className: `px-3 py-1 rounded-full bg-teal-100/10 text-purple-500 text-primary text-sm`,
      children: e,
    }),
  he = [
    {
      year: `2025 — Presente`,
      company: `Quid Intecci`,
      role: `Outsource Analista Programador - Desarrollo de aplicaciones`,
      description: [
        `Participé en la modernización de módulos administrativos para gestión de afiliados, desarrollando funcionalidades para carga de certificados mediante formularios conectados a distintas bases de datos y servidores.`,
        `Implementé mejoras en un módulo traductor basado en XML, permitiendo parametrizar campos para la generación dinámica de reportes.`,
        `Desarrollé mantenimientos para la gestión automatizada de correos, incluyendo destinatarios de tickets vencidos y notificaciones de cierre por afiliado.`,
        `Contribuí en la migración de procesos desde una arquitectura monolítica hacia una aplicación centralizada, eliminando dependencias de terceros y contribuyendo a la reducción de costos operativos.`,
        `Participé en el desarrollo de un gestor seguro de contraseñas, implementando almacenamiento distribuido en bases de datos segmentadas para fortalecer la seguridad de la información.`,
        `Implementé módulos de autenticación, control de acceso por roles, validación de permisos por ruta y gestión de usuarios.`,
        `Diseñe un módulo para la administración de recursos y componentes, permitiendo registrar servicios asociados a recursos de redes, bases de datos e infraestructura, con asignación de usuarios y permisos.`,
        `Desarrollé un módulo de habilitación de servicios para portales de comercio, permitiendo a usuarios externos habilitar servicios según su canal asignado, permitiendo la gestión por supervisores y analistas.`,
        `Participé en el desarrollo e integración de servicios, consultas a bases de datos y generación de información para procesos administrativos y reportes.`,
      ],
      stack: [
        `Java`,
        `React`,
    ...
    },
    {
      ...
      description: [
        `Desarrollé módulos web en .NET para funcionalidades empresariales orientadas a la optimización de procesos, incluyendo gestión de usuarios, roles y permisos.`,
        `Implementé sistemas de notificaciones para clientes y usuarios, mejorando la comunicación y experiencia dentro de las plataformas.`,
        `Desarrollé una plataforma multi empresa de gestión de inversionistas que integra APIs de screening (listas negras y antecedentes), genera automáticamente matrices de riesgo y administra perfiles jerárquicos de usuario, reduciendo en ≈45 % el tiempo de admisión y fortaleciendo el cumplimiento KYC/AML.`,
        `Construí un motor de reservas multiempresa con pasarela de pagos y notificaciones en tiempo real, incrementando la tasa de conversión de reservas.`,
        `Lideré y ejecuté el proyecto “Parval CRM”, un conjunto de portales ejecutivos y back-office que digitaliza el onboarding y la evaluación de riesgo de clientes, acelerando la toma de decisiones y elevando la trazabilidad regulatoria.`,
        `Desarrollé el Sistema de Gestión de Colegiados para CIAGRO (Costa Rica), centralizando membresías, cuotas y certificaciones, y reduciendo en ≈40 % las gestiones administrativas manuales.`,
        `Desarrollé e implementé una plataforma de gestión de pagos y conciliaciones bancarias para instituciones gubernamentales (Softpre), automatizando flujos críticos.`,
      ],
      stack: [
        `Java`,
        `.NET`,
    ...
    },
    {
      ...
      description: [
        `Lideré la creación y desarrollo de tiendas online utilizando WordPress y WooCommerce, optimizando la arquitectura de información, experiencia de usuario y procesos de compra.`,
        `Integré y configuré herramientas de publicidad, analítica y medición, incluyendo Google Ads, Facebook Ads, Google Tag Manager y Google Analytics 4.`,
        `Desarrollé sitios web institucionales responsive utilizando HTML5, CSS3, Sass y JavaScript.`,
        `Implementé buenas prácticas de rendimiento, accesibilidad y optimización, logrando puntuaciones superiores a 90 en Google Lighthouse en diferentes proyectos.`,
        `Automatice procesos de marketing y comunicación mediante integraciones con herramientas de email marketing.`,
      ],
      stack: [
        `WordPress`,
        `WooCommerce `,
    ...
    {
      year: `2019 — 2021`,
      company: `Arya Consulting`,
      role: `Frontend Developer, Freelance`,
      description: [
        `Digitalicé las reservas de un grupo gastronómico con una Progressive Web App (PWA) (WordPress REST API + Service Workers), reduciendo el tiempo de gestión interna en y elevando la ocupación de eventos`,
        `Desarrollé la web institucional de la empresa de asesoría y aceleré el proceso de marketing, integrando  herramientas para automatizar los correos.`,
        `Rediseñé y optimicé el frontend de un CRM de proveedores desarrollado en Java, logrando una interfaz 100 % responsive y reduciendo notablemente los tiempos de carga en dispositivos móviles.`,
      ],
      stack: [
        `React`,
        `JavaScript`,
    ...
    {
      year: `2017 — 2019`,
      company: `Hispanos Soluciones C.A`,
      role: `Frontend Developer`,
      description: [
        `Lideré el equipo Front-End, impulsé la evolución de los nuevos desarrolladores y acorté en los ciclos de entrega de funcionalidades web.`,
        `Diseñé y desplegué tiendas e-commerce con React y JavaScript, elevando y facilitando las ventas de los clientes`,
        `Disminuí un 30 % el tiempo de creación de sitios WordPress mediante el desarrollo de temas reutilizables y de rápida implementación.`,
      ],
      stack: [`React`, `JavaScript`, `Github`, `WordPress`, `HTML`, `CSS`],
    },
    {
      year: `2012 — 2017`,
      company: `Netuno C.A`,
      ...
      description: [
        `Digitalización de planos y documentos técnicos, mejorando la accesibilidad y organización de la información para el equipo de ingeniería.`,
        `Carga de información en sistema de la data del levantamiento, optimizando la gestión de proyectos y facilitando el acceso a datos relevantes para la toma de decisiones.`,
        `Desarrollo de un sistema de gestión de proyectos en Excel, automatizando tareas repetitivas y mejorando la eficiencia en la planificación y seguimiento de proyectos.`,
        `Desarrollo de un sistema de asignación de cartera de clientes a vendedores y teleoperadores, optimizando la distribución de clientes y mejorando la eficiencia en las ventas y atención al cliente.`,
      ],
      stack: [`HTML`, `JavaScript`, `CSS`, `AutoCAD`, `Excel`],
    },
  ],
  ge = () =>
    (0, w.jsxs)(pe, {
              ...
              `div`,
              {
                children: (0, w.jsxs)(`div`, {
                  children: [
                    ...
                    (0, w.jsx)(`ul`, {
                      className: `list-disc mt-4 text-slate-400 leading-relaxed px-5 sm:px-0`,
  ...
  _e = ({ title: e, description: t, stack: n, url: r }) => {
    let i = r && r.length > 0 ? r[0] : void 0,
      a = typeof i == `string` && /^https?:\/\//.test(i),
      o = (0, w.jsxs)(w.Fragment, {
        children: [
          (0, w.jsx)(`h3`, { className: `text-xl font-semibold`, children: e }),
          (0, w.jsx)(`p`, {
          ...
          (0, w.jsx)(`div`, {
            ...
            children: n.map((e) => (0, w.jsx)(O, { text: e }, e)),
          }),
          !a && i
            ? (0, w.jsx)(`div`, {
    ...
    return (0, w.jsx)(`div`, {
      className: `p-6 rounded-2xl border border-slate-800 hover:bg-stone-400/10 transition`,
      children: a
        ? (0, w.jsx)(`a`, {
            href: i,
            target: `_blank`,
  ...
  ve = [
    {
      ...
      description: `Aplicación de gestions de pagos de diferentes comercios, con integración de pasarelas de pago y panel de administración.`,
      stack: [
        `Java`,
        `NextJs`,
        `TypeScript`,
      ...
      url: [`https://portalweb.baccredomatic.com/login`],
    },
    {
      title: `Baclink`,
      description: `Aplicación de gestion de reportes, mantenimientos de afiliados, control de rutas de redes, agencias, certificados y otros recursos asociados a la infraestructura de red de la empresa, sistema de gestión de usuarios, roles y permisos para acceso a recursos y servicios asociados.`,
      stack: [
        `Java`,
        `React`,
        `TypeScript`,
      ...
      url: [`Urls de acceso privado de uso administrativo`],
    },
    {
      title: `Security Framework`,
      description: `Framework de seguridad para gestion de contraseñas, usuarios y servicios asociados a recursos con acceso restringido, con implementación de matenimientos de servicios, recursos, autenticación y autorización.`,
      stack: [
        `Java`,
        `React`,
        `TypeScript`,
    ...
    {
      title: `Parval CRM`,
      description: `Desarrollo de sistemas de gestion de operaciones, Due Diligence, Onboarding y evaluación de riesgo de clientes para el sector financiero, con integración de APIs de screening, generación de matrices de riesgo y gestión jerárquica de usuarios. Se construyó un conjunto de portales ejecutivos y back-office que digitalizó el onboarding y la evaluación de riesgo de clientes, acelerando la toma de decisiones y elevando la trazabilidad regulatoria.`,
      stack: [
        `Java`,
        `React`,
        `TypeScript`,
    ...
    {
      title: `Altio CRM`,
      description: `Sistemas de gestion de operaciones, Due Diligence, Onboarding y evaluación de riesgo de clientes para el sector financiero, con integración de APIs de screening, generación de matrices de riesgo y gestión jerárquica de usuarios.`,
      stack: [
        `Java`,
        `React`,
        `TypeScript`,
      ...
      url: [
        `https://altio-admin.registro.altiosafi.com/`,
        `https://portal.altiosafi.com/#/h/inicio`,
      ],
    },
    {
      title: `Space Manager CRM`,
      description: `Sistemas de gestion de reservas, clientes, pagos y operaciones para el sector de coworking, con integración de pasarelas de pago, notificaciones en tiempo real y panel de administración. Se construyó un motor de reservas multiempresa con pasarela de pagos y notificaciones en tiempo real, incrementando la tasa de conversión de reservas.`,
      stack: [
        `React`,
        `TypeScript`,
        `Java`,
      ...
      url: [`https://spacemanager.io/en/home/`, `https://app.spacemanager.io/`],
    },
    {
      title: `Roxana Frontan`,
      description: `Web institucional que ofrece tratamientos de belleza y salud, con información sobre la empresa, servicios ofrecidos y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://roxanafrontan.com.uy/`],
    },
    {
      title: `Bioerix`,
      description: `Web institucional de empresa de biotecnología, con información sobre la empresa, servicios ofrecidos y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://www.bioerix.com.uy/`],
    },
    {
      title: `Placebo`,
      description: `Web de comunicación digital de temas de interes público, para promover el desarrollo social, cultural, medioambiental, educacional en salud y drechos, ofrece campañas y acciones de RSE, participa en causas sociales y ambientales, con información sobre la empresa, proyectos realizados y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://placebo.uy/`],
    },
    {
      title: `Proincen`,
      description: `Web institucional de servicios de seguridad de protección contra incendios, catalogo de servicios, información sobre la empresa y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://proincen.com.uy/`],
    },
    {
      title: `Refricom`,
      description: `Tienda online de productos de refrigeración, con catálogo de productos, carrito de compras y pasarela de pago.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://refricom.uy/`],
    },
    {
      title: `Neo Sport`,
      description: `Web institucional con catálogo de productos, con información sobre la empresa y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://www.neosport.com.uy/`],
    },
    {
      title: `Domotec`,
      description: `Web institucional que ofrece servios de tecnología de domotica, portección contra incendios, audio y video, con información sobre la empresa, servicios ofrecidos y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://domotec.uy/`],
    },
    {
      title: `Principe Humberto`,
      description: `Catálogo de postre y cafetería, con información sobre la empresa, menú de productos y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://principehumberto.uy/`],
    },
    {
      title: `Project Management Institute`,
      description: `Web institucional de organización Internacional sin fines de lucro, ofrece acceso gratuito a los eventos mensuales`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://pmi.uy/`],
    },
    {
      title: `Dede Merli`,
      description: `Web institucional de arquitectos, con portafolio de proyectos, información sobre desarrollo de obras y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://dedemerli.com/`],
    },
    {
      title: `Oncología Médica`,
      description: `Web institucional de Hospital de Oncología, con información sobre servicios ofrecidos, sección de noticias, eventos y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://oncologiamedica.hc.edu.uy/`],
    },
    {
      title: `Plexus`,
      description: `Web institucional de empresa de soluciones de software para distintos procesos de gestión, orientado a diferentes sectores de la salud.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://plexus.uy/`],
    },
    {
      title: `Gonzalo Barraza`,
      description: `Portfolio personal de Gonzalo Barraza de asesoría contable, con información sobre servicios ofrecidos, sección de noticias y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://gonzalobarraza.com.uy/`],
    },
    {
      title: `GP Servicios Generales`,
      description: `Web institucional de empresa de servicios generales, reparaciones e instalaciones, con información sobre la empresa, servicios ofrecidos y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://gpserviciosgenerales.com/`],
    },
    {
      title: `Aqua-A`,
      description: `Página web de empresa de servicios de agua, con información sobre la empresa, productos ofrecidos y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://aquaamvd.uy/`],
    },
    {
      title: `Synergos`,
      description: `Página web de empresa de consultoría, sección de servicios, contacto y sección de noticias.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://synergos.com.uy/`],
    },
    {
      title: `Equibiota`,
      description: `Página web de empresa de microbiota intestinal, con información sobre la empresa, servicios ofrecidos y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://equibiota.com/`],
    },
    {
      title: `Minting Summit`,
      description: `Página web de evento de minting summit, con información sobre el evento, agenda, ponentes y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://mintingsummit.xyz/`],
    },
    {
      title: `Pomelo Games`,
      description: `Página web de empresa de desarrollo de videojuegos, con información sobre la empresa, catálogo de juegos, sección de noticias y formulario de contacto.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://www.pomelogames.com/`],
    },
    {
      title: `Phoorma`,
      description: `Tienda Online de empapelados, con catálogo de productos, carrito de compras y pasarela de pago.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://phoorma.com/`],
    },
    {
      title: `Epsu`,
      description: `Página de empresa, información de servicios, cursos ofrecidos, formulario de contacto y sección de videoteca.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://epsu.com.uy/`],
    },
    {
      title: `Ignite Latin America`,
      description: `Página web de empresa de consultoría, entrenamientos y proyectos, contacto y sección de noticias.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://ignite-latinamerica.com/`],
    },
    {
      title: `Rio Estiba`,
      description: `Página web multiidioma de empresa operador portuario y logístico, con información sobre servicios, infraestructura, contacto y sección de noticias.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://rioestiba.com.uy/`],
    },
    {
      title: `Golova`,
      description: `Página web de empresa de diseño web, servicios, formulario de contacto y sección de proyectos realizados.`,
      stack: [`Wordpress`, `JavaScript`, `Mailchimp`],
      url: [`https://golova.com.uy/`],
    },
    {
      title: `Walnut`,
      description: `Tienda de muebles de diseño, con catálogo de productos, carrito de compras y pasarela de pago.`,
      stack: [`Wordpress`, `JavaScript`, `Mailchimp`],
      url: [`https://walnut.com.uy/`],
    },
    {
      title: `Garamond`,
      description: `Página web de empresa de diseño web, servicios, formulario de contacto y sección de proyectos realizados.`,
      stack: [`Wordpress`, `JavaScript`, `Mailchimp`],
      url: [`https://garamond.uy/`],
    },
    {
      title: `Ecoconcurso`,
      description: `Web institucional de empresa de gestión de residuos, ofrece cada año un concurso para escuelas de todo el país, con información sobre el concurso, formulario de inscripción y sección de dibujos ganadores. Sistema administrativo para gestión de inscripciones, evaluación de dibujos y publicación de ganadores.`,
      stack: [`HTML`, `PHP`, `CSS`, `JavaScript`],
      url: [`https://www.ecoconcurso.com.uy/`],
    },
    {
      title: `Subtitulos TV`,
      description: `Página web multiidioma que ofrece servicios de subtitulado, con catalogo de servicios, formulario de contacto y sección de preguntas frecuentes.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://subtitulos.tv/`],
    },
    {
      title: `Tuttodeco tienda online`,
      description: `Tienda de decoración y muebles de diseño, con catálogo de productos, carrito de compras y pasarela de pago.`,
      stack: [`Wordpress`, `JavaScript`],
      url: [`https://tuttodeco.com/`],
    },
  ],
  ye = () => {
    let e = ve.slice(0, 5);
      ...
      children: [
        ...
        (0, w.jsx)(`div`, {
          ...
          children: (0, w.jsx)(`a`, {
            ...
            className: `inline-block px-6 py-3 rounded-full bg-slate-800 hover:bg-slate-700 transition text-sm`,
            children: `Ver más`,
          }),
        }),
      ],
    ...
    (0, w.jsx)(pe, {
      ...
      children: (0, w.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, w.jsx)(`p`, {
            className: `max-w-xl mx-auto mt-6 text-slate-400 leading-relaxed`,
            children: `Actualmente estoy disponible para proyectos frontend y oportunidades freelance.`,
          }),
          (0, w.jsx)(`a`, {
            href: `mailto:avivaspati@gmail.com`,
            className: `inline-block mt-10 border border-primary text-primary px-8 py-4 rounded-lg hover:bg-primary/10 transition`,
            children: `Di Hola`,
          }),
        ],
      }),
      ...
      children:
        ...
        e.map((e, t) => {
          if (/^https?:\/\//.test(e)) {
            ...
            return (0, w.jsx)(
              `a`,
              {
                ...
                target: `_blank`,
                rel: `noreferrer`,
                className: `text-purple-500 text-sm hover:underline md:ml-4 mt-4 md:mt-0`,
                children: n,
              },
              `link-${t}`,
            );
          ...
          return (0, w.jsx)(
            `span`,
            {
              className: `text-purple-500 text-sm mt-4 md:mt-0 md:ml-4`,
              children: e,
            },
            `text-${t}`,
          );
  ...
  Ce = () => {
    ...
    return (
      ...
      (0, _.useEffect)(() => {
        typeof window < `u` && window.scrollTo({ top: 0, left: 0 });
      }, []),
      (0, _.useEffect)(() => {
        if (!n.current) return;
        let e = new IntersectionObserver(
          (e) => {
            e.forEach((e) => {
              e.isIntersecting && t((e) => Math.min(ve.length, e + Se));
            });
          },
      ...
      (0, w.jsxs)(`div`, {
        id: `all-projects`,
        className: `pt-8 md:pt-24 max-w-7xl mx-auto px-6 lg:px-12`,
        children: [
          (0, w.jsxs)(`div`, {
            ...
            children: ve
              ...
              .map((e, t) =>
                (0, w.jsx)(
                  `div`,
                  {
                    className: `flex gap-6 items-start py-2 px-0 md:px-4 rounded bg-slate-900/40`,
                    children: (0, w.jsxs)(`div`, {
                      className: `flex-1 p-6 rounded-2xl border border-slate-800 hover:bg-stone-400/10 transition`,
                      children: [
                        (0, w.jsxs)(`div`, {
            ...
            children:
              e < ve.length
                ? (0, w.jsx)(`span`, {
                    ...
                    children: `Cargando más proyectos...`,
                  })
                : (0, w.jsx)(`span`, {
                    className: `text-sm text-slate-400`,
                    children: `No hay más proyectos`,
                  }),
          }),
        ],
      })
...
function we() {
  let [e, t] = (0, _.useState)(() => window.location.pathname);
  return (
    (0, _.useEffect)(() => {
...
ce.createRoot(document.getElementById(`root`)).render(
  (0, w.jsx)(_.StrictMode, { children: (0, w.jsx)(we, {}) }),
);
